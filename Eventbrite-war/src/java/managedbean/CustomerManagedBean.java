...
public class CustomerManagedBean implements Serializable {
    ...
    private UploadedFile eventFile;
    ...
    private byte[] loadEventDefaultImage() {
        try {
            Path imagePath = Paths.get("/Users/timothy/Downloads/Mods/Y2S2_23-24/IS3106/Assignments/Eventbrite/Eventbrite-war/web/resources/images/notavailable.png");
    ...
    public String addEvent() {
        ...
        if (getEventFile() != null) {
            byte[] imageData = getEventFile().getContent();
    ...
    public String addCustomer() {
        if (customerSessionLocal.getCustomerByEmail(getEmail()) != null) {
            ...
            if (getFile() != null) {
                byte[] imageData = getFile().getContent();
                c.setImage(imageData);
            } else {
    ...
    public String updateCustomer() {
        ...
        if (getFile() != null) {
            currCustomer.setImage(getFile().getContent());
            System.out.println("p");
        }
    ...
    public String updateCustomerPassword() {
        FacesContext context = FacesContext.getCurrentInstance();
        String password = currCustomer.getPassword();
        if (password.equals(getPassword()) && getNewPassword() != null) {
    ...
    private byte[] loadDefaultImage() {
        try {
            Path imagePath = Paths.get("/Users/timothy/Downloads/Mods/Y2S2_23-24/IS3106/Assignments/Eventbrite/Eventbrite-war/web/resources/images/pro.jpeg");
            return Files.readAllBytes(imagePath);
        } catch (IOException e) {
            e.printStackTrace();
        }
     ...
     */
    public UploadedFile getEventFile() {
        return eventFile;
    }
     ...
     */
    public void setEventFile(UploadedFile eventFile) {
